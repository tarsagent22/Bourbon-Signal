...
export async function POST(req: NextRequest) {
  ...
  const sessionConfig: Stripe.Checkout.SessionCreateParams = {
    ...
    success_url: `${process.env.NEXT_PUBLIC_APP_URL || "https://proofhunt.co"}/success?session_id={CHECKOUT_SESSION_ID}`,
    cancel_url: `${process.env.NEXT_PUBLIC_APP_URL || "https://proofhunt.co"}/pricing`,
    metadata: {
