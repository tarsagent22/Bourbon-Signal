  ...
  return (
    <main style={{ minHeight: "100vh", background: "var(--color-bg-primary)", padding: "132px 20px 80px", color: "var(--color-text-secondary)", fontFamily: "var(--font-dm-sans)" }}>
      <section style={{ width: "min(680px, 100%)", margin: "0 auto", border: "1px solid rgba(196,148,58,0.22)", padding: "28px" }}>
        <p style={{ margin: 0, color: "var(--color-accent-amber)", fontFamily: "var(--font-jetbrains)", fontSize: "11px", letterSpacing: "0.12em", textTransform: "uppercase" }}>Coverage temporarily unavailable</p>
        <h1 style={{ margin: "14px 0 0", color: "var(--color-text-primary)", fontFamily: "var(--font-playfair)", fontSize: "42px" }}>We could not load this area.</h1>
        <p>Try again in a moment. We will not guess about where bottle information is available.</p>
