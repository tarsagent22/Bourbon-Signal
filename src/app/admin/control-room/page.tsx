          ...
          <details className="cr-details">
            ...
            <div className="cr-detail-grid">
              <dl className="cr-list">
                ...
                {!demand.bottles.length ? <div><dt>Bottle demand</dt><dd>No reportable cohort</dd></div> : null}
              </dl>
              <dl className="cr-list">
...
@media(max-width:980px){.cr-queue-grid{grid-template-columns:1fr}.cr-metrics.four{grid-template-columns:repeat(2,minmax(0,1fr))}}
