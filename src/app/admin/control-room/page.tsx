...
@media(max-width:980px){.cr-queue-grid,.cr-demand-list{grid-template-columns:1fr}.cr-engine-grid,.cr-attention-strip,.cr-metrics.four{grid-template-columns:repeat(2,minmax(0,1fr))}.cr-request-rows article{grid-template-columns:1fr 1fr}.cr-request-actions{grid-column:1/-1;grid-template-columns:1fr auto;align-items:end}}
