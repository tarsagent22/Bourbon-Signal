...
const SEED_BOTTLES: BibleBottle[] = [
  ...
  signalBottle("eagle-rare-10", "Eagle Rare 10 Year", "Eagle Rare", ["eagle rare", "er10", "eagle rare 10"], "allocated", "An allocated 10-year Buffalo Trace bourbon in many markets with classic Buffalo Trace grape, cherry, vanilla sweetness, and a shorter dry finish.", "Good grab near MSRP, especially where local sightings are low. Avoid paying hype pricing when ER12 is close in MSRP."),
  signalBottle("eagle-rare-12", "Eagle Rare 12 Year", "Eagle Rare", ["er12", "eagle rare 12", "eagle rare twelve"], "highly_allocated", "A 95-proof 12-year Buffalo Trace bourbon that drinks darker and more complex than ER10, with grape, blackberry, oak, leather, caramel, and honey.", "Special find near MSRP; at a small MSRP premium over ER10, it is the better neat-sipper buy."),
  ...
  {
    id: "eh-taylor-four-grain",
    canonicalName: "E.H. Taylor Four Grain",
    brand: "E.H. Taylor",
    producer: "Buffalo Trace Distillery",
    category: "bourbon",
    proof: 100,
    ageStatement: "10–12 Year",
    msrp: 80,
    availability: "unicorn",
    buyerVerdict: "special_find",
    aliases: ["eh taylor four grain", "e.h. taylor four grain", "eht four grain", "colonel eh taylor four grain", "colonel e.h. taylor jr. four grain"],
    isSignalTracked: true,
    isAlertEligible: true,
    summary: "A limited bottled-in-bond Buffalo Trace bourbon built from a four-grain recipe of corn, rye, wheat, and malted barley. The original 2017/2018 releases were 12-year whiskey; Buffalo Trace announced its 2026 return as a limited annual release at 10 years.",
    guidance: "Special find near MSRP. Expect very scarce distribution and heavy collector demand; do not let the generic E.H. Taylor name collapse it into Small Batch or Barrel Proof.",
  },
