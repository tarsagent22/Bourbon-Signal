...
for (const phrase of ['ALERT_DELIVERY_ENABLED', 'ALERT_ONSITE_DELIVERY_ENABLED', 'ALERT_EMAIL_DELIVERY_ENABLED', 'ALERT_EMAIL_ALLOWED_RECIPIENTS', 'onSiteBaselineDedupeKeys', 'emailBaselineDedupeKeys', 'baselineEmail', 'baselineOnSiteOnly', 'ALERT_EMAIL_MAX_FRESHNESS_HOURS', 'ALERT_REALTIME_MAX_FRESHNESS_HOURS', 'groupCandidatesByLocation', 'location-group:', 'fresh signal detected', 'manual_refresh_quarantine', 'bootstrap', 'unknown_freshness', 'emailsWouldSend', 'isServerPaidTier(publicMetadata)', 'hasSavedAreaPreferences(areaPrefs)', 'skippedFreeUsers', 'skippedNoAreaPreferences', 'sortCandidatesForMember']) {
