...
assert.match(page, /readSiteExport\("state-health"\)/);
assert.match(page, /All-state operating contract/);
assert.match(page, /customerVisibleDropCount/);
assert.match(page, /recoveryAction/);
