...
assert.match(map, /Coverage strength/, "the map includes a visible strength legend");
...
assert.match(panel, /coverageStrengthLabel/, "the selected-state panel leads with the same honest strength tier");
