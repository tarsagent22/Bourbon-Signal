...
- camera or selected-photo access is permitted only after a member explicitly chooses bottle or shelf evidence; optional foreground location is permitted only after choosing nearby-retailer suggestions, and no permission prompt runs at app launch;
- denial always preserves manual posting or retailer entry; this candidate does not upload evidence photos or expose barcode matching, and it does not request microphone or background location;
