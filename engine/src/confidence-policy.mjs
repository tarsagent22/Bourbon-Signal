...
export const STATE_CONFIDENCE_POLICY = {
  ...
  AL: { maxAlertMode: 'release_watch', inventorySemantics: 'Alabama pages are release/calendar/allocated-list intelligence. Do not present as live inventory until participating store/event details are parsed.', defaultCadence: 'daily-monthly' },
  ...
  IN: { maxAlertMode: 'license_spine_plus_retailer_watch', inventorySemantics: 'Indiana is a private retail market. ATC permit rows identify active package-store locations but are not bottle inventory. Use these as store/location coverage and retailer-targeting infrastructure; only retailer shop endpoints/pages should become bottle watch or inventory signals.', defaultCadence: 'daily-60m' },
