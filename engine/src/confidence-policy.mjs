...
export const STATE_CONFIDENCE_POLICY = {
  ...
  NY: { maxAlertMode: 'policy_only', inventorySemantics: 'New York coverage is deliberately limited to the New York City, Nassau County, and Buffalo first-party retailer allowlist. Only exact merchant, premises, product URL, pickup, and positive orderability evidence may alert; broader New York catalog or shipping presence remains non-inventory.', defaultCadence: '30-60m' },
