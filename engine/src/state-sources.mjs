...
const BASE_STATE_SOURCES = [
  ...
  },
  {
    ...
    value: 'Indiana is a private retail market, not a control-state inventory board. Best current value is statewide active package-store coverage from the public ATC permit lookup plus identity-bound retailer inventory from Target RedSky, Kahn\'s, all 71 Big Red branches, Cap n Cork, Wise Guys, Belmont Beverage/Chalet Party Shoppe, Cork Liquors, Holiday Liquors, 21st Amendment, Penguin Liquor, and Payless Liquors East Street. Rural Inn, SoBro Spirits, and Handy Spot Liquors remain watch/universe sources until they publish exact product availability. ATC permits must never be presented as bottle inventory; delivery aggregators remain watch-only.',
    sources: [
      ...
      { kind: 'html', url: 'https://bigredliquors.com/shop/?subtype=Bourbon', label: 'All 71 Big Red Liquors CityHive branch inventories', precisionOnly: true },
      ...
      { kind: 'html', url: 'https://www.theruralinn.com/the-store', label: 'Rural Inn exact-premises barrel-pick watch (no current product inventory)', precisionOnly: true },
      { kind: 'html', url: 'http://www.sobrospirits.com/', label: 'SoBro Spirits source watch (no public product inventory)', precisionOnly: true },
      { kind: 'html', url: 'https://www.facebook.com/handyspotliquor/', label: 'Handy Spot Liquors premises watch (no public product inventory)', precisionOnly: true },
