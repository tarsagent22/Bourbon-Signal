...
const BASE_STATE_SOURCES = [
  ...
  {
    id: 'NY', label: 'New York City and Nassau County first-party retailer inventory', tier: 'B', strategy: 'retailer_store_inventory', cadence: '30-60m',
    value: 'Exact-premises retailer inventory from the reviewed New York City and Nassau County source registry. Coverage is intentionally limited to the named premises; binary availability is never projected as an exact count.',
    rareSignalTarget: true,
