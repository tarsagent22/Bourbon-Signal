...
const INVENTORY_SOURCES = Object.freeze([
  ...
  },
  {
    ...
    disposition: 'live_inventory',
    sourceLayer: 'private_retailer_inventory',
    firstPartyDomains: ['www.tupelo2go.com'],
    platform: 'tupelo2go',
    platformIds: { marketplaceStoreId: '1187' },
    evidenceUrls: ['https://www.tupelo2go.com/r/1187/restaurants/delivery/Alcohol/Tupelo-Wine-Spirits-tupelo', 'https://tupelowine.com/'],
    ecommerce: true,
    pickup: null,
    exactStoreOrderability: true,
    inventoryAuthoritative: true,
    probeStatus: 'inventory_capable_binary_marketplace_orderability',
  },
  {
    permitNumber: '041251',
    disposition: 'live_inventory',
    ...
    firstPartyDomains: ['www.tupelo2go.com'],
    platform: 'tupelo2go',
    platformIds: { marketplaceStoreId: '1237' },
    evidenceUrls: ['https://www.tupelo2go.com/r/1237/restaurants/delivery/Alcohol/Maya-Wine-Spirits-tupelo'],
    ecommerce: true,
    pickup: null,
    exactStoreOrderability: true,
    inventoryAuthoritative: true,
  ...
  },
  {
    ...
    firstPartyDomains: ['www.tupelo2go.com'],
    platform: 'tupelo2go',
    platformIds: { marketplaceStoreId: '1544' },
    evidenceUrls: ['https://www.tupelo2go.com/r/1544/restaurants/delivery/Alcohol/Bogarts-Liquor-Wine-tupelo'],
    ecommerce: true,
    pickup: null,
    exactStoreOrderability: true,
    inventoryAuthoritative: true,
  ...
  if (!reviewed) {
    ...
    return {
      ...
      reviewProvenance: {
        ...
        reviewedAt: dispositionReview.reviewedAt || REVIEW_DISPOSITIONS.defaultEntryReviewedAt || REVIEW_DISPOSITIONS.reviewedAt,
