...
- Basic My Shelf access with `collectionBottleLimit: 10`; capacity copy appears only near or at the addition boundary, and existing bottles are never hidden after a downgrade.
...
- Unlimited My Shelf plus Bourbon DNA, personalized collection intelligence, and taste-fit recommendations with local opportunities labeled separately.
...
- Free includes basic My Shelf with contextual capacity handling; Standard includes unlimited basic My Shelf; Barrel and Bottled-in-Bond add Bourbon DNA and personalized collection intelligence.
- My Shelf-to-Radar suggestions return no more than three items and never change a watchlist without the member choosing the explicit watch action.
